...
etcdv3::AsyncCompareAndDeleteAction::AsyncCompareAndDeleteAction(etcdv3::ActionParameters param, etcdv3::Atomicity_Type type, CompletionQueue* cq, unsigned long token) 
  :etcdv3::Action(param)
{
...
etcd::Response etcdv3::AsyncCompareAndDeleteAction::ParseResponse()
{
