...
etcdv3::AsyncUpdateAction::AsyncUpdateAction(etcdv3::ActionParameters param, CompletionQueue* cq, unsigned long token)
  : etcdv3::Action(param) 
{
...
etcd::Response etcdv3::AsyncUpdateAction::ParseResponse()
{
