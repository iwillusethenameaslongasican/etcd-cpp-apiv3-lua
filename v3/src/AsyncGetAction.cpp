...
etcdv3::AsyncGetAction::AsyncGetAction(etcdv3::ActionParameters param, CompletionQueue* cq, unsigned long token)
  : etcdv3::Action(param)
{
  ...
  response_reader = parameters.kv_stub->AsyncRange(&context,get_request, cq);
  response_reader->Finish(&reply, &status, (void*)token);
}

etcd::Response etcdv3::AsyncGetAction::ParseResponse()
{
  ...
  etcd::Response resp = etcd::Response(range_resp);          
  return resp;
}
